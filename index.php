...
<body>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="lead my-4">
                        ...
                        Be smart choose<span class="text-warning h4 logo" style="font-family: anand;"> <img src="./images/logo.png" width="auto" height="30px" alt=""></span>
                    </p>
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-md text-light">
                    ...
                    <i class="bi bi-geo-alt h1 text-warning">&nbsp;&nbsp;</i><span class="lead">Damak, Province 1, Nepal</span><br>
                    <i class="bi bi-envelope h1 text-warning">&nbsp;&nbsp;</i><span class="lead">info@gmail.com</span><br>
                    <i class="bi bi-telephone h1 text-warning">&nbsp;&nbsp;</i><span class="lead">+977-9800001111</span>
                </div>
                <div class="col-md text-light ">
    ...
    <footer class="p-1 bg-dark text-white text-center position-relative">
        <div class="container">
            <p class="lead">Copyright&copy; <?php echo Date("Y"); ?><strong> <span class="text-warning h3 logo"><img src=" ./images/logo.png" width="auto" height="25px" alt=""></span></p>
